...
const IRANCELL_COMPONENT_STATUS_LABELS={draft:'پیش‌نویس',published:'منتشر شده',offers_received:'پیشنهاد دریافت شده',selected:'انتخاب شده',booked:'رزرو شده',completed:'تکمیل شده',pending:'در انتظار',signed:'تأیید شده',held:'پرداخت امن',released:'تسویه شده',refunded:'بازگشت وجه',failed:'ناموفق',scheduled:'زمان‌بندی شده',waiting:'اتاق انتظار',ready:'آماده',live:'در حال برگزاری',submitted:'ثبت شده',reviewing:'در حال بررسی',approved:'تأیید شده',rejected:'رد شده',resolved:'حل شده',verified:'تأیید شده',under_review:'در حال بررسی',suspended:'تعلیق شده',active:'فعال',cancelled:'لغو شده'};
export function IrancellBadge({children,tone='neutral'}){return <span className={`ir-badge ir-badge--${tone}`}>{children}</span>}
